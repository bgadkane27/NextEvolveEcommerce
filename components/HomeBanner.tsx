...
const HomeBanner = () => {
    return (
        <div className="flex flex-col items-center justify-center gap-5 mt-5">
            <Title className='w-auto uppercase font-extrabold text-center tracking-wide bg-gradient-to-r from-blue-600 to-pink-500 text-transparent bg-clip-text'>Best Clothing Collection</Title>
